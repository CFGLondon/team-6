...
//      file_put_contents('PDOErrors.txt', $e->getMessage(), FILE_APPEND);
	...
	try {
	  $STH = $DBH->prepare("INSERT INTO `volunteer` (`Username`, `Password`, `Address`, `Interests`, `Date`, `Black`, `White`, `days`, `Reference1Name`, `Reference1Number`, `Reference2Name`, `Reference2Number`) VALUES (:Username, :Password, :Address, :Interests, :Date, :Black, :White, :Days, :Reference1Name, :Reference1Number, :Reference2Name, :Reference2Number)");
